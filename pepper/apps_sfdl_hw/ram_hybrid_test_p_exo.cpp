#include <apps_sfdl_hw/ram_hybrid_test_p_exo.h>
...
ram_hybrid_testProverExo::ram_hybrid_testProverExo() {
...
void ram_hybrid_testProverExo::init_exo_inputs(
  const mpq_t* input_q, int num_inputs,
  char *folder_path, HashBlockStore *bs) {
  
}

void ram_hybrid_testProverExo::export_exo_inputs(
  const mpq_t* output_q, int num_outputs,
  char* folder_path, HashBlockStore *bs) {

}

void ram_hybrid_testProverExo::run_shuffle_phase(char *folder_path) {

}

void ram_hybrid_testProverExo::baseline_minimal(void* input, void* output){
  //Run the computation
}

void ram_hybrid_testProverExo::baseline(const mpq_t* input_q, int num_inputs, 
...
//Refer to apps_sfdl_gen/ram_hybrid_test_cons.h for constants to use in this exogenous
//check.
bool ram_hybrid_testProverExo::exogenous_check(const mpz_t* input, const mpq_t* input_q,
