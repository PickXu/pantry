#ifndef APPS_SFDL_GEN_RAM_HYBRID_TEST_P_EXO_H_
#define APPS_SFDL_GEN_RAM_HYBRID_TEST_P_EXO_H_

#include <apps_sfdl_gen/ram_hybrid_test_p.h>
...
*/
class ram_hybrid_testProverExo : public ExogenousChecker {
  public:
    ram_hybrid_testProverExo();
...
#endif  // APPS_SFDL_GEN_RAM_HYBRID_TEST_P_EXO_H_
