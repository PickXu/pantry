...
#include <apps_sfdl_hw/cql_rw_update_v_inp_gen_hw.h>
...
cql_rw_updateVerifierInpGenHw::cql_rw_updateVerifierInpGenHw(Venezia* v_)
{
  v = v_;
  compiler_implementation.v = v_;
}

//Refer to apps_sfdl_gen/cql_rw_update_cons.h for constants to use when generating input.
void cql_rw_updateVerifierInpGenHw::create_input(mpq_t* input_q, int num_inputs)
{
